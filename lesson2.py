...
def fifth_paragraph():
    ...
    # новый рейтинг необходимо вставить в внутрь списка
        ...
        sub_rate = rating.copy()
        # добавляем новое значение в скопированный список
        sub_rate.append(new_rate)
        # сортируем полученый список в обратном порядке
        sub_rate.sort(reverse=True)
        # находим индекс нового рейтинга в отсортированном списке
        idx = sub_rate.index(new_rate)
