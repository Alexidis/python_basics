...
if __name__ == '__main__':
    ...
    new_store = l8.p4_Store()
    scanner1 = l8.p4_Scanner('brand', 'model', 123.00, 11)
    scanner2 = l8.p4_Scanner('brand2', 'model2', 456.00, 10)
    printer = l8.p4_Printer('brand3', 'model3', 123.00, 20)
